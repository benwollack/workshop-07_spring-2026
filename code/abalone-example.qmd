...
Note: Make sure a code and data folder are separated, this keeps things organized.
...
H~0~: **pH does not affect abalone growth in change in shell surface area per day**  

H~A~: **pH does affect abalone growth in change in shell surface area per day**
...
First column of numbers gives us the model estimates. Then standord errors, t values and p values for the estimates. We can see all p values are below 0.05, so there's confidence that neither the slope or y-int is 0.
...
**At pH = 8, the model predicts abalone shell growth of 5.36 [5.08, 5.64] mm^2^ d^-1^.**
